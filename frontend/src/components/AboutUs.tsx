...
// import imageToAdd from "./assets/trashcan_test_image.jpg";

export default function AboutPage() {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-cyan-200 px-4 text-center">
              {/* Back button in top-left corner */}
        <Link
            href="/"
            className="bg-lime-800 text-white px-4 py-1 rounded hover:bg-cyan-600 flex items-center gap-2"
        >
            ← Back
        </Link>
